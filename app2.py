...
def travel_planner(city, interests, days, budget, language):
    state = {
        "city": city,
    ...
    if language != "English":
        state["itinerary"] = translator.translate(state["itinerary"], dest=language).text
...
if st.button("🚀 Generate Itinerary"):
    with st.spinner("🔮 Generating your futuristic itinerary..."):
        itinerary_text = travel_planner(city, interests, days, budget, languages[selected_language])
